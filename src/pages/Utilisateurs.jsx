        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm space-y-4">
            <div className="flex justify-between items-center">
              ...
              <button onClick={() => setUserToDelete(null)} className="text-gray-400 hover:text-gray-600 cursor-pointer">
                <X size={20} />
              </button>
            </div>
            <p className="text-gray-600 text-sm">
              Voulez-vous vraiment supprimer <span className="font-bold text-slate-800">{userToDelete.username}</span> ? Cette action est irreversible.
            </p>
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                className="flex-1 py-2 rounded-xl bg-red-500 text-white font-semibold hover:bg-red-600 transition text-sm cursor-pointer"
              >
                Supprimer
              </button>
            </div>
            ...
            <div key={user.id} className="bg-white p-4 rounded-xl border border-gray-100 flex justify-between items-center shadow-sm">
                ...
                <div>
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {user.role === "etablissement" && (
                      <span className="text-xs bg-blue-100 text-blue-600 px-2 py-0.5 rounded-full font-medium">Etablissement</span>
                    )}
                  </div>
              ...
              <div className="flex gap-2 flex-shrink-0">
                ...
                <button
                  ...
                  className={`p-2 transition-colors cursor-pointer ${user.role === "admin" ? "text-[#FEBD00]" : "text-gray-400 hover:text-[#FEBD00]"}`}
                ...
                <button
                  ...
                  className={`p-2 transition-colors cursor-pointer ${user.role === "etablissement" ? "text-blue-500" : "text-gray-400 hover:text-blue-500"}`}
