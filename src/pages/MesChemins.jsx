...
const MesChemins = () => {
  ...
  // ✅ Récupère establishment_name depuis localStorage
  ...
  const resetForm = () => {
    setFormData({
      title: "",
      start_label: "",
      end_label: establishmentName, // ✅ remet le nom après création
      end_lat: "",
      end_lng: "",
      start_lat: "",
      start_lng: "",
              ...
              <form onSubmit={handleCreate} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    />
                    {/* Arrivée = nom établissement, non modifiable */}
                    ...
                    {formData.steps.map((step, index) => (
                      <div key={index} className="border border-gray-100 rounded-xl p-3 space-y-2 bg-gray-50/50">
                        ...
                        <input type="text" placeholder="Description"
                          value={step.text} onChange={(e) => updateStep(index, "text", e.target.value)}
